...
window.NattyListe = (function () {
  ...
  function poserCss() {
    ...
    st.textContent = [
      ...
      '.nl-btn.pri{background:var(--ink,#101014);color:var(--on-ink,#fff)}',
      ...
      '.nl-box{width:21px;height:21px;border-radius:50%;border:2px solid var(--line,#d3d3d8);flex-shrink:0;',
      ...
      'color:var(--muted,#a8a8b2);font-family:inherit;display:flex;align-items:center;justify-content:center}',
      ...
      'background:var(--ink,#101014);color:var(--on-ink,#fff);font-size:13px;font-weight:700;padding:11px 17px;',
